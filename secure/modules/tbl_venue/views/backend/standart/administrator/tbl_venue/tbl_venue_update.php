<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCOi5vktJx2fjOA4X9orhT_-v2SIvsv060 ">
</script>
...
<section class="content-header">
	<h1>
		Tbl Venue <small>Edit Tbl Venue</small>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							...
							<h5 class="widget-user-desc">Edit Tbl Venue</h5>
							<hr>
						</div>
						<?= form_open(base_url('administrator/tbl_venue/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_tbl_venue', 
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="user_id" id="user_id"
									data-placeholder="Select User Id">
									<option value=""></option>
									<?php foreach (db_get_all_data('tbl_user') as $row): ?>
									<option <?=$row->id == $tbl_venue->user_id ? 'selected' : ''; ?> value="
										<?= $row->id ?>">
										<?= $row->name; ?>
									</option>
									<?php endforeach; ?>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								...
								<input class="data_file data_file_uuid" name="tbl_venue_image_uuid"
									id="tbl_venue_image_uuid" type="hidden"
									value="<?= set_value('tbl_venue_image_uuid'); ?>">
								<input class="data_file" name="tbl_venue_image_name" id="tbl_venue_image_name"
									type="hidden" value="<?= set_value('tbl_venue_image_name', $tbl_venue->image); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="title" id="title" placeholder="Title"
									value="<?= set_value('title', $tbl_venue->title); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="sports[]" id="sports"
									data-placeholder="Select Sports" multiple>
									<option value=""></option>
									<?php foreach (db_get_all_data('tbl_sports') as $row): ?>
									<option <?=in_array($row->id, explode(',', $tbl_venue->sports)) ? 'selected' : '';
										?> value="
										<?= $row->id ?>">
										<?= $row->sport_name; ?>
									</option>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="amenities[]"
									id="amenities" data-placeholder="Select Amenities" multiple>
									<option value=""></option>
									<?php foreach (db_get_all_data('tbl_amenities') as $row): ?>
									<option <?=in_array($row->id, explode(',', $tbl_venue->amenities)) ? 'selected' :
										''; ?> value="
										<?= $row->id ?>">
										<?= $row->name; ?>
									</option>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<textarea id="description" name="description" rows="10"
									cols="80"> <?= set_value('description', $tbl_venue->description); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<textarea id="address" name="address" rows="5"
									class="textarea"><?= set_value('address', $tbl_venue->address); ?></textarea>
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input autocomplete="off" type="text" class="form-control" name="address_map"
									id="address_map" placeholder="Address Map"
									value="<?= set_value('address_map', $tbl_venue->address_map); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="latitude" id="latitude"
									placeholder="Latitude" value="<?= set_value('latitude', $tbl_venue->latitude); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="longitude" id="longitude"
									...
									value="<?= set_value('longitude', $tbl_venue->longitude); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="video_url" id="video_url"
									...
									value="<?= set_value('video_url', $tbl_venue->video_url); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select" name="status" id="status"
									...
									<option value=""></option>
									<option <?=$tbl_venue->status == "1" ? 'selected' :''; ?> value="1">Active</option>
									<option <?=$tbl_venue->status == "2" ? 'selected' :''; ?> value="2">Inactive
									</option>
								</select>
								<small class="info help-block">
...
<script>
	$(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_tbl_venue.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#tbl_venue_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#tbl_venue_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/tbl_venue/get_image_file/<?= $tbl_venue->id; ?>',
