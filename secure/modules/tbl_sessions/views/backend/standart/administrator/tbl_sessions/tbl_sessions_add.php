...
<section class="content-header">
    <h1>
        Academy Sessions        <small><?= cclang('new', ['Academy Sessions']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Academy Sessions']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="classes" id="classes" placeholder="Classes" value="<?= set_value('classes'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="type" id="type" data-placeholder="Select Type" >
                                    ...
                                    <option value="short_classes">Short classes</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="interval" id="interval" placeholder="Interval" value="<?= set_value('interval'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_sessions/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
