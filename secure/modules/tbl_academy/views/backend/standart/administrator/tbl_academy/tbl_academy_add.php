...
<section class="content-header">
    <h1>
        Tbl Academy        <small><?= cclang('new', ['Tbl Academy']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tbl Academy']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_academy_logo_uuid" id="tbl_academy_logo_uuid" type="hidden" value="<?= set_value('tbl_academy_logo_uuid'); ?>">
                                <input class="data_file" name="tbl_academy_logo_name" id="tbl_academy_logo_name" type="hidden" value="<?= set_value('tbl_academy_logo_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="head_coach" id="head_coach" placeholder="Head Coach" value="<?= set_value('head_coach'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="session_timings" id="session_timings" placeholder="Session Timings" value="<?= set_value('session_timings'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="week_days" id="week_days" placeholder="Week Days" value="<?= set_value('week_days'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks_price" id="remarks_price" placeholder="Remarks Price" value="<?= set_value('remarks_price'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="skill_level" id="skill_level" placeholder="Skill Level" value="<?= set_value('skill_level'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="academy_jersey" id="academy_jersey" placeholder="Academy Jersey" value="<?= set_value('academy_jersey'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="capacity" id="capacity" placeholder="Capacity" value="<?= set_value('capacity'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks_current_capacity" id="remarks_current_capacity" placeholder="Remarks Current Capacity" value="<?= set_value('remarks_current_capacity'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="session_plan" id="session_plan" placeholder="Session Plan" value="<?= set_value('session_plan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks_session_plan" id="remarks_session_plan" placeholder="Remarks Session Plan" value="<?= set_value('remarks_session_plan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="age_group_of_students" id="age_group_of_students" placeholder="Age Group Of Students" value="<?= set_value('age_group_of_students'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks_students" id="remarks_students" placeholder="Remarks Students" value="<?= set_value('remarks_students'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="equipment" id="equipment" placeholder="Equipment" value="<?= set_value('equipment'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks_on_equipment" id="remarks_on_equipment" placeholder="Remarks On Equipment" value="<?= set_value('remarks_on_equipment'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="flood_lights" id="flood_lights" placeholder="Flood Lights" value="<?= set_value('flood_lights'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ground_size" id="ground_size" placeholder="Ground Size" value="<?= set_value('ground_size'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="person" id="person" placeholder="Person" value="<?= set_value('person'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="coach_experience" id="coach_experience" placeholder="Coach Experience" value="<?= set_value('coach_experience'); ?>">
                                <small class="info help-block">
                                <b>Input Coach Experience</b> Max Length : 300.</small>
                                                ...
                                                <div class="form-group ">
                            <label for="no_of_assistent_coach" class="col-sm-2 control-label">No Of Assistant Coach 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_of_assistent_coach" id="no_of_assistent_coach" placeholder="No Of Assistent Coach" value="<?= set_value('no_of_assistent_coach'); ?>">
                                <small class="info help-block">
                                <b>Input No Of Assistant Coach</b> Max Length : 100.</small>
                            </div>
                        </div>
                                                 
                                                <div class="form-group ">
                            <label for="assistent_coach_name" class="col-sm-2 control-label">Assistant Coach Name 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="assistent_coach_name" id="assistent_coach_name" placeholder="Assistent Coach Name" value="<?= set_value('assistent_coach_name'); ?>">
                                <small class="info help-block">
                                <b>Input Assistant Coach Name</b> Max Length : 200.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="feedbacks" id="feedbacks" placeholder="Feedbacks" value="<?= set_value('feedbacks'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_academy/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_logo = $('#tbl_academy_logo_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_logo !== 'undefined') {
                    $('#tbl_academy_logo_galery').fineUploader('deleteFile', id_logo);
                }
