...
<section class="content-header">
    <h1>
        Tbl Experience        <small>Edit Tbl Experience</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Tbl Experience</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/tbl_experience/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="<?= set_value('title', $tbl_experience->title); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="description" name="description" rows="5" class="textarea"><?= set_value('description', $tbl_experience->description); ?></textarea>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="price" id="price" placeholder="Price" value="<?= set_value('price', $tbl_experience->price); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="tbl_experience_image_galery_listed">
                                <?php foreach ((array) explode(',', $tbl_experience->image) as $idx => $filename): ?>
                                    <input type="hidden" class="listed_file_uuid" name="tbl_experience_image_uuid[<?= $idx ?>]" value="" /><input type="hidden" class="listed_file_name" name="tbl_experience_image_name[<?= $idx ?>]" value="<?= $filename; ?>" />
                                <?php endforeach; ?>
                                </div>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="status" id="status" data-placeholder="Select Status" >
                                    <option value=""></option>
                                    <option <?= $tbl_experience->status == "1" ? 'selected' :''; ?> value="1">Active</option>
                                    <option <?= $tbl_experience->status == "2" ? 'selected' :''; ?> value="2">Inactive</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="venue_id" id="venue_id" data-placeholder="Select Venue Id" >
                                    ...
                                    <option <?=  $row->id ==  $tbl_experience->venue_id ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->title; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="address" id="address" placeholder="Address" value="<?= set_value('address', $tbl_experience->address); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="start_time" id="start_time" placeholder="Start Time" value="<?= set_value('start_time', $tbl_experience->start_time); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_tbl_experience.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#tbl_experience_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#tbl_experience_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/tbl_experience/get_image_file/<?= $tbl_experience->id; ?>',
