...
<section class="content-header">
    <h1>
        Tbl Facilities        <small><?= cclang('new', ['Tbl Facilities']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tbl Facilities']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_of_inventories" id="no_of_inventories" placeholder="No Of Inventories" value="<?= set_value('no_of_inventories'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="min_players" id="min_players" placeholder="Min Players" value="<?= set_value('min_players'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="max_players" id="max_players" placeholder="Max Players" value="<?= set_value('max_players'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="default_players" id="default_players" placeholder="Default Players" value="<?= set_value('default_players'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="price_per_slot" id="price_per_slot" placeholder="Price Per Slot" value="<?= set_value('price_per_slot'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="opening_time" id="opening_time" placeholder="Opening Time" value="<?= set_value('opening_time'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="closing_time" id="closing_time" placeholder="Closing Time" value="<?= set_value('closing_time'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="slot_length_hrs" id="slot_length_hrs" placeholder="Slot Length Hrs" value="<?= set_value('slot_length_hrs'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="slot_length_min" id="slot_length_min" placeholder="Slot Length Min" value="<?= set_value('slot_length_min'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="slot_frequency" id="slot_frequency" placeholder="Slot Frequency" value="<?= set_value('slot_frequency'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="activity" id="activity" placeholder="Activity" value="<?= set_value('activity'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_facilities/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
