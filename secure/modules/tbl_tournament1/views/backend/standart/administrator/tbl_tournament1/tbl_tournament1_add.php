...
<section class="content-header">
    <h1>
        Tbl Tournament1        <small><?= cclang('new', ['Tbl Tournament1']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tbl Tournament1']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_tournament1_image_uuid" id="tbl_tournament1_image_uuid" type="hidden" value="<?= set_value('tbl_tournament1_image_uuid'); ?>">
                                <input class="data_file" name="tbl_tournament1_image_name" id="tbl_tournament1_image_name" type="hidden" value="<?= set_value('tbl_tournament1_image_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_tournament1/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_image = $('#tbl_tournament1_image_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_image !== 'undefined') {
                    $('#tbl_tournament1_image_galery').fineUploader('deleteFile', id_image);
                }
