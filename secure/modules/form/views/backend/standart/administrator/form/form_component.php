   ...
   <div class="tab-content height-100pr">
      ...
      <div class="tool-wrapper">
         ...
         <table class="table table-responsive table table-striped " id="tools">
            <?php $i = 1;
            foreach (db_get_all_data('crud_input_type') as $toolbox) : ?>
               <?php if (in_array($toolbox->type, $this->crud_builder->getFieldNotShowInFormComponent())) continue; ?>
               <?php if ($toolbox->type == 'file_multiple') continue; ?>
               ...
               <tr>
                           ...
                           <label>
                              <div class="setting-name"><span><?= cclang('show_in_column'); ?> ?</span>
                                 <div class="pull-right">
                                    <input class="switch-button pull-right" type="checkbox" checked="" name="form[{field_id}][{field_name}][show_in_column]" value="yes" title="automatic generated help block">
                                 </div>
                              </div>
                           </label>
                        </div>
                        ...
                        <div class="custom-option-contain">
                           <div class="custom-option-item">
                              <div class="box-custom-option padding-left-0 box-top">
                                 <div class="col-md-3"><?= cclang('value') ?></div> <input type="text" name="form[{field_id}][{field_name}][custom_option][0][value]"></label>
                              </div>
                              <div class="box-custom-option padding-left-0 box-bottom">
                                 <div class="col-md-3"><?= cclang('label') ?></div> <input type="text" name="form[{field_id}][{field_name}][custom_option][0][label]">
                              </div>
                  ...
                  <td class="hide-preview" width="35%">
                     <div class="col-md-12">
                        <div class="form-group ">
                           <select class="form-control chosen chosen-select validation" name="form[{field_id}][{field_name}][validation]" id="validation" tabi-ndex="5" data-placeholder="+ <?= cclang('add_rules') ?>">
