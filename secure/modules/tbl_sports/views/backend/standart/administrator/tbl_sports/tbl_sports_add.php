...
<section class="content-header">
    <h1>
        Sports        <small><?= cclang('new', ['Sports']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Sports']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sport_name" id="sport_name" placeholder="Sport Name" value="<?= set_value('sport_name'); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_sports_sport_icon_uuid" id="tbl_sports_sport_icon_uuid" type="hidden" value="<?= set_value('tbl_sports_sport_icon_uuid'); ?>">
                                <input class="data_file" name="tbl_sports_sport_icon_name" id="tbl_sports_sport_icon_name" type="hidden" value="<?= set_value('tbl_sports_sport_icon_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sport_price" id="sport_price" placeholder="Sport Price" value="<?= set_value('sport_price'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_sports/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_sport_icon = $('#tbl_sports_sport_icon_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            if (typeof id_sport_icon !== 'undefined') {
                    $('#tbl_sports_sport_icon_galery').fineUploader('deleteFile', id_sport_icon);
                }
