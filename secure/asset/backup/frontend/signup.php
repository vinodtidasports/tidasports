           ...
           ?>
                    ...
                    <div class="center-log">
                      <div class="input-container">
                        ...
                        <input class="input-field" type="text" placeholder="Your Email" name="useremail">
                      </div>
                      <div class="input-container">
                        <i class="fa icon"><img src="<?=base_url('uploads/front/')?>images/lock.png" alt=""></i>
                        <input class="input-field" type="password" placeholder="Password" name="userpassword">
                      </div>
                      <div class="input-container">
                        <i class="fa icon"><img src="<?=base_url('uploads/front/')?>images/lock.png" alt=""></i>
                      ...
                      <div class="checkbox text-left">
                        <label><input type="checkbox" name="usertype" value="2"> Signup as Influencer </label>
                      </div>
                      <button type="submit" class="btn btn-info">Sign Up</button>
                      <p> Already have an  account? <a href="<?=base_url('login')?>">SignIn</a> </p>
                    </div>
                <?= form_close(); ?>
              </div>
