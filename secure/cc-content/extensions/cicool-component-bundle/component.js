...
CcPageElement.addComponentItem({
  ...
  'item_content': '<div class="container">' +
    ...
    '<img src="' + BASE_URL_EXTENSION + '/img/placeholder.png" alt="Pulpit Rock" class="width-100prn">' +
    '<div class="caption">' +
    ...
    '<div class="thumbnail">' +
    '<a href="' + BASE_URL_EXTENSION + '/img/placeholder.png" target="_blank">' +
    '<img src="' + BASE_URL_EXTENSION + '/img/placeholder.png" alt="Moustiers Sainte Marie" class="width-100prn">' +
    '<div class="caption">' +
    '<p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>' +
    '</div>' +
    '</a>' +
    ...
    '<div class="thumbnail">' +
    '<a href="' + BASE_URL_EXTENSION + '/img/placeholder.png" target="_blank">' +
    '<img src="' + BASE_URL_EXTENSION + '/img/placeholder.png" alt="Cinque Terre" class="width-100prn">' +
    '<div class="caption">' +
    '<p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>' +
    '</div>' +
    '</a>' +
...
CcPageElement.addComponentItem({
  ...
  'item_content': '<iframe  width="560" height="315" src="https://www.youtube.com/embed/grItaOxuyTE" frameborder="0" allowfullscreen></iframe>' +
    '<div class="video video-wrapper widged-cover" contenteditable="false">' +
    '</div>',
  'component_group': 'media'
});
