...
<head>
  ...
  <style type="text/css">
   ...
   .login__new  .login-box-body
    ...
    .login__new .login-box, 
    .login__new .register-box
    {
      margin:0;
    }
  </style>
...
<body class="hold-transition login-page login__new">
<div class="login-box">
  ...
  <div class="login-box-body">
   ...
   <div class="callout callout-<?= $type; ?>"  style="color:#C82626">
    ...
    <!--<a href="<?= site_url('forgot-password'); ?>"><?= cclang('i_forgot_my_password'); ?></a><br>-->
