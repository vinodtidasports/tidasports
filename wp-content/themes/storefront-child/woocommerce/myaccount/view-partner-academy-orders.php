...
if (!empty($data)) {
    echo "<div class='customer-bookings-container partner-bookings-container'>";
    echo "<table class='customer-bookings-table partner-bookings-table'>";
    echo "<thead class='customer-bookings-table_head partner-bookings-table_head'>";
    echo "<tr><th>Order Id</th><th>Name</th><th>Email</th><th>Status</th><th>Price</th><th>Action</th></tr>";
    echo "</thead>";

    echo "<tbody class='customer-bookings-table_body partner-bookings-table_body'>";
        ...
        if ($order) {
            ...
            foreach ($items as $item) {
                ...
                if ($user) {
                    ...
                    echo "<tr>";
                    // echo "<td>#$order_id</td>";
		    echo "<td><a class='customer-bookings-table_body_view_btn' href='../../view-booking-order/$order_id'>#$order_id</a></td>";
                    echo "<td>$product_name</td>";
                    echo "<td>$user_email</td>"; // Display user email
                    echo "<td>$product_status</td>";
                    echo "<td>$product_price</td>";
                    echo "<td><a class='customer-bookings-table_body_view_btn' href='../../view-booking-order/$order_id'>View</a></td>";
                    echo "</tr>";
                } else {
