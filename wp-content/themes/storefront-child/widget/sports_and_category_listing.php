...
<?php
    ...
    // echo $taxonomy_value;
    $sport_terms = json_decode(do_shortcode("[getting_tida_sports_and_category taxonomy='$taxonomy_value' type='$type']"));
    // echo do_shortcode("[getting_tida_sports_and_category taxonomy='$taxonomy_value']");
...
<div class="tida-sports_and_category-widget <?php echo $taxonomy_value; ?>">
    <div class="tida-sports_and_category-widget-container">
        ...
        foreach ($sport_terms as $term) :
            // var_dump($term);
            ?>
            <a href="<?php echo ((isset($type) && $type === 'Shop') ? '?sport='.$term->slug : get_term_link($term)); ?>">
