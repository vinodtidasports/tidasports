...
class WC_Bookings_Admin {
	...
	public function styles_and_scripts() {
		...
		wp_enqueue_style( 'wc_bookings_admin_styles', WC_BOOKINGS_PLUGIN_URL . '/dist/admin.css', array( 'wp-components' ), WC_BOOKINGS_VERSION );
		...
		if ( 'wc_booking_page_wc_bookings_settings' === $screen->id ) {
			if ( WC_BOOKINGS_GUTENBERG_EXISTS ) {
				...
				wp_enqueue_style( 'wc_bookings_admin_store_availability_css', WC_BOOKINGS_PLUGIN_URL . '/dist/admin-store-availability.css', null, WC_BOOKINGS_VERSION );
			}
		}
