...
<div id="bookings_availability" class="panel woocommerce_options_panel">
	<div class="options_group">
		...
		<?php
		$more_info_link = ' <a href="https://woocommerce.com/document/introduction-to-woocommerce-bookings/woocommerce-bookings-store-manager-guide/availability-settings/#restrict-selectable-days">' . esc_html__( 'view our documentation here.', 'woocommerce-bookings' ) . '</a>';
		woocommerce_wp_checkbox(
			array(
