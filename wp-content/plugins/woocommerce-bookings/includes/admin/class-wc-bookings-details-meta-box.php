					...
					<div class="booking_data_column">
						...
						<p class="form-field form-field-wide">
							...
							try {
								...
								<?php
							} catch ( Exception $e ) { // phpcs:ignore Generic.CodeAnalysis.EmptyStatement.DetectedCatch -- Ignore invalid order item ID errors, e.g., when an order item is deleted.
							}
							?>
						</p>
						<?php
