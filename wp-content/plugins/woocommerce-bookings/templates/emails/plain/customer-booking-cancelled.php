...
echo esc_html( __( 'We are sorry to say that your booking could not be confirmed and has been cancelled. The details of the cancelled booking can be found below.', 'woocommerce-bookings' ) ) . "\n\n";
...
echo esc_html( __( 'Please contact us if you have any questions or concerns.', 'woocommerce-bookings' ) ) . "\n";
